...
La parte que separa al que *usa* algoritmos del que los *entiende*: complejidad, notación asintótica, recurrencias, computabilidad y cálculo. Cada enlace abre el notebook renderizado en el sitio.
...
## Habilidades de Resolución de Problemas: Técnicas de Análisis de Problemas
...
## Habilidades de Resolución de Problemas: Complejidad Algorítmica y Optimización
...
## Transición a Experto: Matemáticas y Teoría detrás de los Algoritmos
...
- **[Cálculo 1A (MITx)](calculo-mitx.md)** — el lenguaje del cambio continuo, base de muchos métodos numéricos y de ML.
