...
<img src="https://avatars.githubusercontent.com/u/294888?v=4" width="220" align="right" style="border-radius:12px; margin-left:1.5rem;">

Soy **Igor Parra Bastias**, desarrollador de software senior y autodidacta con una
amplia trayectoria en ingeniería y desarrollo de software. Mi aventura en el mundo
tecnológico empezó a los 14 años y desde entonces no he parado de aprender.

Mi primer contacto con la computación fue a través de un fascículo especial de la
revista *Icarito*. Aquel primer algoritmo —cómo preparar una taza de café— capturó
mi atención. Aprendí que un computador se conceptualiza en tres partes: **entrada de
datos, un proceso (la caja negra) y salida de información**. Treinta y cinco años
...
El contenido educativo (apuntes, diapositivas, material de cursos) se publica bajo
**CC BY-NC-SA 4.0**. El código fuente, bajo licencia **MIT**. Puedes usar, compartir y
modificar el material dándome crédito; el contenido educativo, sin fines comerciales y
compartiendo bajo los mismos términos.
